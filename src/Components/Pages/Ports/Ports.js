            ...
            <Fade bottom>
              <div className="left">
                ...
                <div className="content_section">
                  <h4>Description</h4>
                  <p>
                    Le port de plaisance de Marseille - Vieux-Port est situé
                    dans le Bouches-du-Rhône. Il dispose d'une capacité
                    d'accueil de 3200 bateaux sur pontons. Le port de Marseille
                    - Vieux-Port dispose d'un espace visiteurs pour vos escales
                    avec 20 places disponibles. Attention, le tirant d'eau
                    maximum est de 6 m.
                  </p>
                </div>
                ...
                <div className="content_section">
                  ...
                  <div className="notice_cards">
                    <div className="notice_card">
                      ...
                      <p>
                        Daniel est très arrangeant, notre séjour était
                        excellent, et la propreté du bateau est irréprochable.
                        Au plaisir de relouer votre bateau !
                      </p>
                    </div>
                    <div className="notice_card">
                      <div className="profile">
