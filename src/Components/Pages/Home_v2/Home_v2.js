        ...
        <div className="module">
          <div className="left">
            ...
            <div className="content_section">
              ...
              <p>
                Bonjour, <br />
                Je propose une location de mon bateau (450 CV) qui se situe sur
                le port de Marseille. N’hésitez pas à me contacter si
            ...
            <div className="content_section">
              ...
              <div className="notice_cards">
                <div className="notice_card">
                  ...
                  <p>
                    Daniel est très arrangeant, notre séjour était excellent, et
                    la propreté du bateau est irréprochable. Au plaisir de
            ...
            <div className="content_section">
              ...
              <p>
                Une annulation 2 jours avant la date entraine le paiement de la
                première journée de location
              </p>
            </div>
          </div>
          <div className="right">
