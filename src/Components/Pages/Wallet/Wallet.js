      ...
      <Fade bottom>
        <div className="wallet_name">
          ...
          <button className="button_small button_black">
            <Link to="/join-us">Enregistrer un nouveau bateau</Link>
          </button>
        </div>
      </Fade>
      ...
      <div className="container">
        <div className="wallet_content_wrapper">
          ...
          <Fade bottom delay={250}>
            <button className="button_small button_black">
              <Link to="/join-us">Transférer vers mon compte</Link>
            </button>
          </Fade>
          ...
          {card === "" && (
            <Fade delay={500}>
              ...
              >
                <SwiperSlide>
                  <div onClick={() => setCard("card")} className="wallet_card">
      ...
      {card === "card" && (
        <div className="card_details container-medium-886px">
          ...
          <button className="button button_black">
            <Link to="/join-us">Partager ma NFCard</Link>
          </button>
        </div>
      )}
          ...
          <Fade bottom delay={100}>
            <div className="grid_col_3">
              ...
              >
                ...
                <p>
                  Ajoutez un document (assurance, acte de francisation, facture
                  d'entretien...) a une de vos NFCards
                </p>
              </div>
              <div
